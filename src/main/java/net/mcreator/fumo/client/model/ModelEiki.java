...
public class ModelEiki<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("fumo", "model_eiki"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition BowLeftLeg = LeftLeg.addOrReplaceChild("BowLeftLeg",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.1464F, -0.6319F, -0.8184F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55).addBox(-0.6464F, -0.6319F, -0.3184F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BowRightLeg = RightLeg.addOrReplaceChild("BowRightLeg",
				CubeListBuilder.create().texOffs(0, 55).addBox(-0.25F, -0.5F, -0.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55).addBox(-0.75F, -0.5F, -0.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bowleft_r1 = bow.addOrReplaceChild("bowleft_r1", CubeListBuilder.create().texOffs(5, 55).addBox(-1.0F, -0.9503F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.35F, 4.0503F, 6.364F, 0.0F, -0.7854F, 0.0F));
		PartDefinition bowright_r1 = bow.addOrReplaceChild("bowright_r1", CubeListBuilder.create().texOffs(5, 55).addBox(-0.5F, -0.9503F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.35F, 4.0503F, 6.364F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition bowleft_r2 = LeftArmBow.addOrReplaceChild("bowleft_r2", CubeListBuilder.create().texOffs(0, 55).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.35F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
		PartDefinition bowright_r2 = LeftArmBow.addOrReplaceChild("bowright_r2", CubeListBuilder.create().texOffs(0, 55).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.35F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
