...
public class ModelNitori<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nitori"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Backpack = Torso.addOrReplaceChild("Backpack",
				CubeListBuilder.create().texOffs(47, 54)
						.addBox(-10.5F, -7.5F, 10.0F, 5.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 57)
						.addBox(-10.0F, -7.6F, 9.1F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(37, 60)
						.addBox(-10.0F, -3.8F, 12.6F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(31, 59)
						.addBox(-5.5F, -3.8F, 10.7F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 59)
						.addBox(-11.5F, -3.8F, 10.7F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 60)
						.addBox(-11.0F, -6.5F, 10.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(15, 60)
						.addBox(-5.9F, -6.5F, 10.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 52)
						.addBox(-5.6F, -6.2F, 11.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-11.3F, -6.2F, 11.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-5.2F, -3.5F, 11.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-11.8F, -3.5F, 11.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-8.5F, -3.5F, 12.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-7.1F, -5.7F, 12.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)).texOffs(60, 52)
						.addBox(-9.9F, -5.7F, 12.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.22F)),
